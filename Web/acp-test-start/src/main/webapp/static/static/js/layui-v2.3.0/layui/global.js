...
layui.define(['code', 'element', 'table', 'util'], function(exports){
  ...
  ;!function(){
    ...
    ,'<option value="">搜索acp功能</option>'
      ,'<option value="acp/gateway2.htm">使用介绍</option>'
      ,'<option value="acp/acpEnvListForAlgo.htm">自动生成模型</option>'
      ,'<option value="acp/gateway5.htm">模型创建</option>'
      ,'<option value="acp/gateway4.htm">模型列表</option>'
      ,'<option value="acp/pressClimbing.htm">爬山算法简介</option>'
//      ,'<option value="element/button.html">button 按钮</option>'
//      ,'<option value="element/form.html">form 表单�</option>'
//      ,'<option value="element/form.html#input">input 输入�</option>'
//      ,'<option value="element/form.html#select">select 下拉选择�</option>'
//      ,'<option value="element/form.html#checkbox">checkbox 复��</option>'
//      ,'<option value="element/form.html#switch">switch ��</option>'
//      ,'<option value="element/form.html#radio">radio 单��</option>'
//      ,'<option value="element/form.html#textarea">textarea 文本�</option>'
//      ,'<option value="element/nav.html">nav 导航菜单</option>'
//      ,'<option value="element/nav.html#breadcrumb">breadcrumb 面包�</option>'
//      ,'<option value="element/tab.html">tabs 选项�</option>'
//      ,'<option value="element/progress.html">progress 进度�</option>'
//      ,'<option value="element/collapse.html">collapse 折叠面板/手��</option>'
//      ,'<option value="element/table.html">table 表格元素</option>'
//      ,'<option value="element/badge.html">badge 徽章</option>'
//      ,'<option value="element/timeline.html">timeline 时间�</option>'
//      ,'<option value="element/auxiliar.html#blockquote">blockquote 引用�</option>'
//      ,'<option value="element/auxiliar.html#fieldset">fieldset 字��</option>'
//      ,'<option value="element/auxiliar.html#hr">hr 分割�</option>'

//      ,'<option value="modules/layer.html">layer 弹出�/弹窗综合</option>'
//      ,'<option value="modules/laydate.html">laydate 日期时间选择�</option>'
//      ,'<option value="modules/layim.html">layim 即时通�/聊天</option>'
...
//      ,'<option value="modules/colorpicker.html">colorpicker 颜色选择�</option>'
//      ,'<option value="modules/slider.html">slider 滑块</option>'
//     ,'<option value="modules/carousel.html">carousel 轒�/跑马�</option>'
//      ,'<option value="modules/layedit.html">layedit 富文朼�辑器</option>'
//      ,'<option value="modules/tree.html">tree 树形菜单</option>'
//      ,'<option value="modules/flow.html">flow 信息�/图片懒加�</option>'
//      ,'<option value="modules/util.html">util 工具�</option>'
//      ,'<option value="modules/code.html">code 代码俥�</option>'
    ,'</select>'].join(''));
